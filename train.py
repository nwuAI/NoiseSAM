...
parser.add_argument('--warm_iter', type=int, default=6000,help='labeled data') 
parser.add_argument('--method', type=str, default='ssl_dualmask_same_NoiseSAM')
parser.add_argument('--promptmode', type=str, default='point',help='prompt')
parser.add_argument('--promptmode_mask', type=str, default='mask',help='prompt')
