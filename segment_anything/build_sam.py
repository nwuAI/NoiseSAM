...
from .modeling import ImageEncoderViT1,ImageEncoderViT2, MaskDecoder, PromptEncoder_prompt_class, Sam, TwoWayTransformer, Sam_dualmask_same_prompt_class_random_large
...
def _build_sam(
    ...
    image_embedding_size = image_size // vit_patch_size  # Divide by 16 here
    sam = Sam(
        image_encoder=ImageEncoderViT2(
            depth=encoder_depth,
            embed_dim=encoder_embed_dim,
            img_size=image_size,
            mlp_ratio=4,
