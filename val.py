...
def test_single_image_BUSI(image, label, net, classes, multimask_output=True, patch_size=[512, 512]):
...
def test_single_image_Synapse(image, label, net, classes, multimask_output=True, patch_size=[512, 512]):
